        ...
        <div className="flex items-center justify-between h-full px-4 lg:px-6 max-w-[1920px] mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={() => setPage('home')} className="flex items-center gap-2.5 group">
              <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-lux-primary via-lux-accent to-lux-primary flex items-center justify-center shadow-glow-primary transition-shadow duration-300 group-hover:shadow-md">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="white">
                  <path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                </svg>
              </div>
              <span className="font-display font-semibold text-base hidden sm:inline tracking-tight">
                IPTV Lux
              </span>
            </button>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-xl text-xs text-lux-muted border border-white/[0.06] bg-white/[0.03] hover:bg-white/[0.06] hover:text-white transition-all duration-200"
            >
